...
namespace MarsRoverApp
{
    ...
    {
        private PlateauCoordinates plateauCoordinates { get; set; }
        public Rover Rover { get; private set; }
        public Plateau(int xMaxLimit, int yMaxLimit)
        {
            plateauCoordinates = new PlateauCoordinates(xMaxLimit,yMaxLimit);
        }
